  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.message || `حدث خطأ في الشبكة، الكود: ${response.status}`,
        );
      }
        ...
        >
          ...
          >
            ...
            <input
              ...
              type="text"
              placeholder={t(
                "enter_required_quantity",
                "Enter required quantity (in KG or Tons)",
              )}
            />
